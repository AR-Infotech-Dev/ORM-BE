...
//   email: { label: "Email", type: "email" },
  ...
  email_app_password: { label: "Email App Password" },
  date_format: { label: "Date Format" },
  time_format: { label: "Time Format" },
  order_prefix: { label: "Order Prefix" },
  order_prefix_padding: { label: "Order Prefix Padding" },
  order_include_year: { label: "Order Include Year" },
  order_no_reset: { label: "Order Reset" },
  finacial_year: { label: "Financial Year" },
  default_currency: { label: "Default Currency" },
  order_validation: { label: "Order Validation" },
  terms_and_conditions: { label: "Terms & Conditions" },
//   tax_code: { label: "Tax Code" },
//   gst_rate: { label: "GST Rate" },
//   cgst_rate: { label: "CGST Rate" },
//   sgst_rate: { label: "SGST Rate" },
//   igst_rate: { label: "IGST Rate" },
//   hsn_code: { label: "HSN Code" },
//   status: { label: "Status" },
};
