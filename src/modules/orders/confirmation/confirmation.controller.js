...
export const list = async (req, res) => {
  try {
    ...
    //  where.push("t.order_status IN ('waiting')");
// ****************************************
...
export const getDetails = async (req, res) => {
  try {
    ...
    const orderDetails = await CommonModel.GetMasterListDetails({
      select: "t.*, d.name as dealer_name, d.email as dealer_email, d.mobile as dealer_mobile, d.address as dealer_address, d.code as dealer_code,  d.gstin as dealer_gstin, d.dealer_type, u.name as userName",
      table: MODULE_TABLE,
      where: [
        `order_id = ${order_id}`
      ],
